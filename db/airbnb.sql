...
CREATE TABLE `bookings` (
  ...
  KEY `bookings_rentals_id_fk` (`rental_id`),
  CONSTRAINT `bookings_rentals_id_fk` FOREIGN KEY (`rental_id`) REFERENCES `rentals` (`id`),
...
CREATE TABLE `rental_equipment` (
  ...
  KEY `rental_equipment___fk` (`equipment_id`),
  CONSTRAINT `rental_equipment___fk` FOREIGN KEY (`equipment_id`) REFERENCES `equipments` (`id`),
  CONSTRAINT `rental_equipment_rentals_id_fk` FOREIGN KEY (`rental_id`) REFERENCES `rentals` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rentals` (
  ...
  `type` int(1) NOT NULL,
  `surface` decimal(5,0) NOT NULL,
  `description` mediumtext NOT NULL,
  `capacity` int(2) NOT NULL,
  `price` decimal(7,0) NOT NULL,
  `address_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `rentals_addresses_id_fk` (`address_id`),
  KEY `rentals_users_id_fk` (`owner_id`),
  CONSTRAINT `rentals_addresses_id_fk` FOREIGN KEY (`address_id`) REFERENCES `addresses` (`id`),
...
-- Dump completed on 2022-04-25 14:12:30
